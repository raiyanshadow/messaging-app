...
/**
 * Interface for accessing the chat channel table in our database.
 */
public interface ChatChannelDataAccessObject {
     ...
     * @return The latest {@code AbstractMessage} entity, or {@code null} if the channel has no messages.
     * @throws SQLException If a database access error occurs.
     */
    AbstractMessage getLastMessage(String channelUrl) throws SQLException;
}
